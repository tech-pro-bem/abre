...
const sobreNos: SobreNos = {
  ...
  text: `
  Somos a ABRE e nossa missão é acolher pessoas com esquizofrenia e de seus familiares. 
...
const stylizeWords = (text: string) => {
  ...
  return text
    .split(regex)
    .map((words, index) =>
      wordsInBold.includes(words) ? <strong key={index}>{words}</strong> : words
    );
};
...
export const About = () => {
  return (
    <div className="container__about">
      ...
      <h2 className="container__about__title">{sobreNos.title}</h2>

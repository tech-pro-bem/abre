...
import { FooterSocials } from "./socials.tsx";
  ...
  return (
    <footer className={styles.footer}>
      <div className={styles.footer_container}>
        <div className={styles.logo_socials_container}>
          <Image
        ...
        <div className={styles.footer_content}>
          <div className={styles.donation_container}>
            <Image
              ...
              height={123}
            />
            <div className={styles.donation_text_content}>
          ...
          <NavBar />
          <div className={styles.lgpd_and_icons_container}>
